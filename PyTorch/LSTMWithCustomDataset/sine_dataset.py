...
class SineWaveDataset(Dataset):
    ...
    def __init__(self, data_path, identifier='default', sequence_length=5, forecast=1):
        ...
        Args:
            ...
            forecast: our far out we are forecasting i.e. determines our y label
    ...
    def __getitem__(self, idx):
        ...
        y = hf.get(self.__identifier)[idx+self.__sequence_length+self.__forecast-1] # the minus 1 is due to the sequence length
        hf.close()
        return X, y
